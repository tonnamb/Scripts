...
VaryTime = range(0,10001,1000)
RCNear = 32.0

inputfolder = "2ns/k_0.7/ui_range150_7090"
foldername = "ui_range150_7090"
...
for i in runrange:
	shutil.copy("../../" + inputfolder + "/data/"+str(i),foldername + "/data/"+str(i))
...
for i in runrange:
	...
	line = file.readline()
	line = file.readline()
        with open(foldername + "/data/" + str(i),"a") as out:
            while line:
                rows = line.split()
		if rows[0] != '#':
